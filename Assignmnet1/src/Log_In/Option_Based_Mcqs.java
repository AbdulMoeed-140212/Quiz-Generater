...
public class Option_Based_Mcqs {
   ...
   static String File_name;
	...
	public static void Write_option_based_mcq_screen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Option_Based_Mcqs window = new Option_Based_Mcqs(File_name);
	 ...
	 */
	public Option_Based_Mcqs(String name) {
		this.File_name=name;
		initialize();
	}
