...
public class True_False_Based_Mcqs {
	 ...
	 */
	public static void Write_T_F_based_mcq_screen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					True_False_Based_Mcqs window = new True_False_Based_Mcqs(File_name);
	 ...
	 */
	public True_False_Based_Mcqs(String f) {
		this.File_name = f;  
		initialize();
	}
